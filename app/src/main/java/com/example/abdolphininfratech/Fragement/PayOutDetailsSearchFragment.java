...
public class PayOutDetailsSearchFragment extends Fragment {

    EditText et_from_date, et_to_date,secrh_by_payout_no;
    Button btn_search;
    private DatePickerDialog mDatePickerDialog,getmDatePickerDialog;
    String title="PayOut Details";
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.payout_deatails_search_fragment, container, false);
        ...
        secrh_by_payout_no=view.findViewById(R.id.search_by_payout_no);
       setDateTimeField();
       setToDateTimeField();
    ...
    public void SendData()
    {
        ...
        String search_by_payoutNumber=secrh_by_payout_no.getText().toString().trim();
        Fragment mFragment = null;
        Bundle bundle=new Bundle();
        bundle.putString("From_Date",From_Date);
        bundle.putString("To_Date",To_Date);
        bundle.putString("Payout_Number",search_by_payoutNumber);
        mFragment = new PayoutDetailsFragment();
